...
* **Algoritmo de No-Solapamiento:** El sistema valida automáticamente que no existan conflictos horarios, calculando la duración exacta de cada service antes de confirmar.
* **Consulta de Disponibilidad:** Endpoint especializado que calcula los tramos horarios libres filtrando por barbero y fecha.
* **Control de Agenda:** El administrador dispone de una visión global de las appointments para optimizar los tiempos de sus empleados.
...
* **Carrito de Compra:** Flujo de compra integrado que permite al user adquirir productos junto a su appointment o de forma independiente.
...
* **Reportes de Facturación:** Visualización de ingresos totales derivados tanto de servicios (appointments) como de ventas directas de productos.
...
2.  **Servicios (Business Logic):** Capa donde residen los algoritmos de validación de appointments y la orquestación de pagos.
